      ...
      <div className="onboarding-body">
        <motion.div className="onboarding-card"
          ...
          <p className="onboarding-sub">
            ...
            You'll be notified if Arjun moves outside these zones.
          </p>
...
<<<<<<< HEAD
              onClick={() => {
                ...
                alert('🎉 Setup complete! Redirecting to Guardian Dashboard…')
                navigate('/dashboard')
              }}>
=======
              onClick={() => navigate('/dashboard')}>
>>>>>>> 3c44fd109675a7869954568aacbcf4cb55ac6532
              <CheckCircle size={18} /> Finish Setup → Go to Dashboard
            </button>
          </div>
        </motion.div>
      </div>

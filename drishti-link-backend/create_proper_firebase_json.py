#!/usr/bin/env python3
"""
Create Firebase service account JSON with proper newlines in private key
"""
...
# Add the private key to the service account
...
print("✅ Created firebase-service-account.json with proper newlines")
...
with open('firebase-service-account.json', 'r') as f:
    ...
    elif '-----BEGIN PRIVATE KEY-----\n' in content:
        print("✅ Has actual newlines in private key")
    else:

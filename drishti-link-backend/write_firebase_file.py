#!/usr/bin/env python3
"""
Write Firebase service account JSON with actual newlines in private key
"""

# Write the JSON file manually with proper formatting
firebase_json = '''{
...
print("✅ Created firebase-service-account.json with actual newlines")
